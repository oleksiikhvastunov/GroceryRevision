...
ts.utilVarCommon = [ts.hhSize,ts.hhSize.*ts.logInc,data(:,2),ts.logInc.*data(:,2),log(data(:,8)),ts.logInc.*log(data(:,8)),data(:,10),ts.logInc.*data(:,10),data(:,11),ts.logInc.*data(:,11)];
clear size;
